    ...
    <>
      <div className="flex flex-col items-center justify-center pt-12 ">
        ...
        <label className="inline-flex items-center cursor-pointer mb-4">
          <input type="checkbox" checked={simulationRunning} className="sr-only peer" onChange={() => { if ((!temperature || !date) && !simulationRunning) alert("Please set the simulation context"); else { setSimulationRunning(!simulationRunning); setCurrentProfile({ profile_username: "TBD", profile_type: "TBD" }); } }} />
      ...
      <div className=" flex flex-row justify-evenly items-center border-2 border-blue-500 rounded-md my-5 mx-10">
